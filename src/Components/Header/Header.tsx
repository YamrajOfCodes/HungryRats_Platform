      ...
      <div className="relative px-6 sm:px-12 py-12 sm:py-20 flex flex-col sm:flex-row items-center justify-between">
        ...
        <div className="w-full sm:w-1/2 z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
           <button className="bg-yellow-400 w-2/3 md:w-2/3 lg:w-1/3 xl:w-1/4  text-blue-900 px-8 py-3 rounded-lg font-semibold hover:bg-yellow-300 transition-all hover:scale-105 flex items-center justify-center gap-2 group">
           <Link href={"/menu"}>
              Order Now
           </Link>
