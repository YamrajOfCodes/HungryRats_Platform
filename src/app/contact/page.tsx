 ...
 const page  = () => {
  ...
  return (
   ...
   <Footer/>
              ...
              <div className={`fixed flex justify-center -top-10 items-center bg-black/20 backdrop-blur-0 h-[110vh] w-full z-10 ${showsignuppopup?'block':'hidden'}`} onClick={hideLoginpopup}>
